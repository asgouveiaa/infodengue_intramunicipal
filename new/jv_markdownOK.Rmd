...
A tabela abaixo sumariza, considerando até a mesma semana epidemiológica `r week_atual` em relação ao ano anterior, os casos notificados acumulados, a incidência acumulada por 100 mil habitantes e, para comparação, a proporção de casos acumulados em relação aos notificados no ano passado.
...
```{r fig4, echo=FALSE, fig.cap="Figura 4: Curva de incidência de Dengue (A) e Chikungunya (B) - Joinville/SC até SE 32/2025", fig.height=8}
fig5
...
```{r fig6, echo=FALSE, fig.cap="Figura 6 : Nível de atenção de Dengue (A) e Chikungunya (B) em cada semana epidemiológica do município.", fig.height=8}
fig6
...
```{r fig7, echo=FALSE, fig.cap="Figura 7: Receptividade climática do município e temperatura mínima até SE 32/2025", fig.height=6, message=FALSE, warning=FALSE}
fig7
...
```{r fig8, echo=FALSE, fig.cap="Figura 8: Comparação da incidência do ano atual com do ano passado para Dengue (A) e Chikungunya (B)", fig.height=8}
fig8
...
```{r fig9, echo=FALSE, fig.cap="Figura 9: Número reprodutivo semanal de Dengue (A) e Chikungunya (B) para o município estimado até SE 32/2025", fig.height=8}
fig9
...
```{r tab7, echo=FALSE, fig.cap="Nota: Os quatro níveis de alerta do Infodengue e a relação com o nível de atenção do Plano de Contingência Nacional estão descritos na tabela em anexo."}
tab7_ok
...
```{r fig10, echo=FALSE, fig.cap="Figura 10: Curva de incidência de Dengue para os Distritos Centro, Norte e Sul até a SE 32/2025", fig.height=11}
fig10
...
```{r fig11, echo=FALSE, fig.cap="Figura 11: Incidência de dengue (casos por 100.000 habitantes) nos distritos nas últimas 3 semanas epidemiológicas", fig.height=8}
fig11
...
```{r fig12, echo=FALSE, fig.cap="Figura 12: Curva de incidência de Chikungunya para os Distritos Centro, Norte e Sul até a SE 32/2025", fig.height=11}
fig12
...
```{r fig13, echo=FALSE, fig.cap="Figura 13: Incidência de Chikungunya (casos por 100.000 habitantes) nos distritos nas últimas 3 semanas epidemiológicas", fig.height=8}
fig13
...
```{r fig14, echo=FALSE, fig.cap="Figura 14: Nível de atenção de cada semana epidemiológica do município por distrito e arbovirose", fig.height=8}
fig14
...
```{r fig15, echo=FALSE, fig.cap="Figura 15: Comparação da incidência de dengue dos Distritos do ano atual com do ano passado", fig.height=8}
fig15
```
...
```{r fig16, echo=FALSE, fig.cap="Figura 16: Número reprodutivo de dengue por Distrito semanal estimado até SE 32/2025", fig.height=8}
fig16

```

```{r fig17, echo=FALSE, fig.cap="Figura 17: Número reprodutivo de chikungunya por Distrito semanal estimado até SE 32/2025", fig.height=8}
fig17
...
```{r fig18, echo=FALSE, fig.cap="Figura 18: Curva de incidência de Dengue nos bairros de maior incidência na semana 32/2025", fig.height=11}
fig18
...
```{r fig19, echo=FALSE, fig.cap="Figura 19: Incidência de Dengue nos bairros nas últimas 3 semanas epidemiológicas", fig.height=8}
fig19
...
```{r fig20, echo=FALSE, fig.cap="Figura 20: Curva de incidência de Chikungunya nos bairros de maior incidência na semana 32/2025", fig.height=11}
fig20
...
```{r fig21, echo=FALSE, fig.cap="Figura 21: Incidência nos bairros nas últimas 3 semanas epidemiológicas", fig.height=8}
fig21
